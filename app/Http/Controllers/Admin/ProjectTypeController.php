...
class ProjectTypeController extends BaseController
{
	public function add()
    {
        return view('cp.projecttype.add');
    }
    ...
    public function edit($id)
    {
        ...
        if($obj){
                return view('cp.projecttype.edit', compact('obj'));
        }
        else{
            return null;
        }
    ...
    public function editpost(Request $request)
    {
		...
		if ($validator->passes()) 
        {
            ...
            $count = ProjectType::where('id',$id)->count();

            if($count > 0){
                ProjectType::where('id',$id)->update([
                'title' => $request['title'],
                'subtitle' => $request['subtitle'],
			    //'desccode' => $request['desccode'],
                //'file' => $img_cat,
    ...
    {
        return view('cp.projecttype.index');
    }
    public function ajax(Request $request)
    {
        ...
        $data = ProjectType::where(function($query) {
                $query->orWhere('id', '<>', -1);
            });
    ...
    public function projecttype_active(Request $request)
	{
		$ids = $request->data;
