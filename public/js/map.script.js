...
//  google map 2 function custom ========================== //
	...
	if(jQuery('#gmap_canvas2').length){
		function init_map2() {
			var myOptions = {
				zoom: 10,
				center: new google.maps.LatLng(31.5159799,34.4494692),
			...
			marker2 = new google.maps.Marker({
				map: map2,
				position: new google.maps.LatLng(31.5159799,34.4494692),
				optimized: false,
			...
			infowindow2 = new google.maps.InfoWindow({
				content: '<strong>Title</strong><br>Capital Mall, Remal st, GAZA, Palestine<br>'
			});
...
//  google map 4 default function custom ========================== //
	...
	if(jQuery('#gmap_canvas4').length){
		function init_map4() {
			var myOptions = {
				zoom: 10,
				center: new google.maps.LatLng(31.5157578,34.4498051),
				mapTypeId: google.maps.MapTypeId.ROADMAP,
			...
			marker4 = new google.maps.Marker({
				map: map4,
				position: new google.maps.LatLng(31.5135558,  34.4507546),
				optimized: false,
...
//  google map 6 default function custom ========================== //
	...
	if(jQuery('#gmap_canvas6').length){
		function init_map6() {
			var myOptions = {
				zoom: 10,
				center: new google.maps.LatLng(31.1157520,34.4498020),
				mapTypeId: google.maps.MapTypeId.ROADMAP,
			...
			marker6 = new google.maps.Marker({
				map: map6,
				position: new google.maps.LatLng(31.5157578,34.4498051),
				optimized: false,
				icon: new google.maps.MarkerImage('images/marker2.png')
			});
