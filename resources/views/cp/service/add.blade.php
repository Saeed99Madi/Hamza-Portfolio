                        ...
                        <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="name" name="name"  class="form-control form-control-solid" placeholder="{{__("service.enter").' '.__("service.name")}}" autocomplete="off">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="icon_name" name="icon_name" value="" class="form-control form-control-solid" placeholder="{{__("service.enter").' '.__("service.icon_name")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                ...
                                <div class="col-md-12" style="direction:ltr;">
									<div class="form-group">
										...
										<textarea class="form-control summernote" id="desc" name="desc" rows="3" ></textarea>
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                <div class="col-md-4">
