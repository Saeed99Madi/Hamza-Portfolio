							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                    ...
                                    <div class="row p-0">
										...
										<a href="#server-side"></a>خدمة جديدة</h1>
                                        <div class="d-flex justify-content-end" style="width: 50%;" data-kt-docs-table-toolbar="base">
											<a class="btn btn-primary" target="_blank" href="{{ route('admin.service.add') }}" title="إضافة جديد">
											    ...
											    <table id="kt-datatable" class="table align-middle table-row-dashed fs-6 gy-5">
												    <thead>
													    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                                            ...
                                                            <th style="padding-right: 10px;">تكلفة المشروع</th>
    ...
    return {
        ...
        init: function () {
            e = $("#kt-datatable").DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.service.index.ajax') }}"
                    ...
                    render: function (e, t, n) {
                        ...
                        var x = '\
                                <div class="d-flex justify-content-end flex-shrink-0">\
									<a target="_blank" href="{{ route("admin.service.edit") }}/'+n.id+'" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" target="_blank" title="تعديل بيانات مستفيد '+n.name+'">\
										<span class="svg-icon svg-icon-3">\
											{!!__("icon.edit")!!}\
										</span>\
									</a>\
                                    <a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 mt-clipboard" data-clipboard=true data-clipboard-action="copy" data-clipboard-text="{{route("home.project")}}/'+n.id+'" >\
                                    <span class="svg-icon svg-icon-3">\
											{!!__("icon.points")!!}\
										</span>\
                                    </a>\
                                    <a target="_blank" data-id="'+n.id+'" href="{{ route("admin.menu.add") }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 btnMenu" >\
                                    <span class="svg-icon svg-icon-3">\
											{!!__("icon.permmision")!!}\
										</span>\
                                    </a>\
...
$("#btnSearch").click(function(){
    ...
    var q = $('#q').val();
                ...
                /*if (book == "" && name == "" && donor == "" && institute == "" && service == "" && service_type == '' && date_from == '' && date_to == ''
                && p_service_type == "" && p_service == "" && p_date == "") {
