                                ...
                                <div class="col-md-6">
									<div class="form-group">
                                        ...
                                        <select id="typeid" name="typeid" class="form-control">
                                            <option value="">إختر من القائمة</option>
                                            <option value="0"> قائمة الرئيسية</option>
                                            <option value="1"> قائمة footer 1</option>
                                            <option value="2"> قائمة footer 2</option>
                                            <option value="3"> قائمة footer 3</option>
                                            <option value="4"> قائمة footer 4</option>
                                            <option value="5"> قائمة footer 5</option>
                                        </select>
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
