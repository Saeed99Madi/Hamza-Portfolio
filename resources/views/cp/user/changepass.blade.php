			...
			<div class="col-lg-12">
				<div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
						<h3 class="card-title" style="font-weight:bold;">{{__('changepass.info')}}</h3>
                        ...
                        <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										<label>{{__("changepass.oldpassword")}}</label>
										<input type="text" id="oldpassword" name="oldpassword" value="" class="form-control form-control-solid" placeholder="{{__("changepass.enter").' '.__("changepass.oldpassword")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                <div class="col-md-6">
									<div class="form-group">
										<label>{{__("changepass.password")}}</label>
										<input type="text" id="password" name="password" value="" class="form-control form-control-solid" placeholder="{{__("changepass.enter").' '.__("changepass.password")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                <div class="col-md-6">
									<div class="form-group">
										<label>{{__("changepass.password_confirmation")}}</label>
										<input type="text" id="password_confirmation" name="password_confirmation" value="" class="form-control form-control-solid" placeholder="{{__("changepass.enter").' '.__("changepass.password")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
							</div>
