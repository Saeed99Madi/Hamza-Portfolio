                ...
                <div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                    ...
                    <div class="row p-0">
                        ...
                        <div class="d-flex justify-content-end" style="width: 50%;" data-kt-docs-table-toolbar="base">
                            <a class="btn btn-primary" target="_blank" href="{{ route('admin.member.add') }}" title="إضافة جديد">
...
@section('js')
    ...
    <script>
            ...
            return {
                ...
                init: function () {
                    e = $("#kt-datatable").DataTable({
                        ...
                        ajax: {
                            url: "{{ route('admin.member.index.ajax') }}"
                        ...
                        columnDefs: [
                            ...
                            },
                            {
                                ...
                                <div class="d-flex justify-content-end flex-shrink-0">\
									<a target="_blank" href="{{ route("admin.member.edit") }}/'+n.id+'" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" target="_blank" title="تعديل بيانات مستفيد '+n.name+'">\
        ...
        $("#btnSearch").click(function(){
            ...
            /*if (book == "" && name == "" && donor == "" && institute == "" && member == "" && member_type == '' && date_from == '' && date_to == ''
            && p_member_type == "" && p_member == "" && p_date == "") {
