							...
							<div class="card mb-2">
								...
								<div class="card-body fs-6 py-15 px-10 py-lg-15 px-lg-15 text-gray-700">
                                    ...
                                    <div class="row p-0">
										...
										<a href="#server-side"></a>المراسلات</h1>
											    ...
											    <table id="kt-datatable" class="table align-middle table-row-dashed fs-6 gy-5">
												    <thead>
													    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
														    ...
														    <th style="padding-right: 10px;" width="10%">الإسم</th>
                                                            <th style="padding-right: 10px;" width="15%">العنوان</th>
                                                            <th style="padding-right: 10px;" width="50%">الرسالة</th>
