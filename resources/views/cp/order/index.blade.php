											    ...
											    <table id="kt-datatable" class="table align-middle table-row-dashed fs-6 gy-5">
												    <thead>
													    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
														    ...
														    <th style="padding-right: 10px;" width="20%">الإسم</th>
                                                            <th style="padding-right: 10px;" >الجوال</th>
                                                            <th style="padding-right: 10px;" >الإيميل</th>
                                                            <th style="padding-right: 10px;" >الإجمالي</th>
    ...
    return {
        ...
        init: function () {
            e = $("#kt-datatable").DataTable({
                ...
                ajax: {
                    url: "{{ route('admin.order.index.ajax') }}"
                ...
                },
                {
                    ...
                    className: "text-end",
                    render: function(e, t, n) {
                            var x =  '<div class="badge badge-light-success fw-bolder">Enabled</div>';
                            return x;
					}
                    ...
                    render: function (e, t, n) {
                        var x = '\
                                <div class="d-flex justify-content-end flex-shrink-0">\
                                    <a href="{{ route("admin.order.details") }}/'+n.id+'" class="btn PopUp btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" title="عرض التفاصيل">\
...
myApp.controller('ViewController', function ($scope, $http, $rootScope) {
    ...
    $scope.exportFun = function(){
        ...
        if (date_from == '' && date_to == '' && q == "") {
            Swal.fire('خطأ...', 'الرجاء ادخال حقل واحد على الاقل!', 'warning');
            return false;
        }
        var link = "/admin/order/export?q=" + $("#q").val()
