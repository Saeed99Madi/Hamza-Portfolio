                        ...
                        <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="title" name="title" value="" class="form-control form-control-solid" placeholder="{{__("projecttype.enter").' '.__("projecttype.title")}}" autocomplete="off">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="subtitle" name="subtitle" value="" class="form-control form-control-solid" placeholder="{{__("projecttype.enter").' '.__("projecttype.subtitle")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                <!--
