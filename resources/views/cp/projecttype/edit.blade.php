			...
			<div class="col-lg-12">
				<div class="card card-custom gutter-b example example-compact">
                    <div class="card-header">
						<h3 class="card-title" style="font-weight:bold;">{{__('projecttype.info')}}</h3>
                        ...
                        <div class="row">
                                <div class="col-md-6">
									<div class="form-group">
										<label>{{__("projecttype.title")}}</label>
										<input type="text" id="title" name="title" value="{{$obj?$obj->title:''}}" class="form-control form-control-solid" placeholder="{{__("projecttype.enter").' '.__("projecttype.title")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                                <div class="col-md-6">
									<div class="form-group">
										<label>{{__("projecttype.subtitle")}}</label>
										<input type="text" id="subtitle" name="subtitle" value="{{$obj?$obj->subtitle:''}}" class="form-control form-control-solid" placeholder="{{__("projecttype.enter").' '.__("projecttype.subtitle")}}" autocomplete="off">
										<span class="fv-plugins-message-container invalid-feedback" role="alert"><strong class="error_text"></strong></span>
									</div>
								</div>
                               <!-- 
                                <div class="col-md-12">
									<div class="form-group">
										<label>{{__("projecttype.desccode")}}</label>
                                ...
                                <div class="col-md-6">
									<div class="form-group">
										<label style="clear: both; display: block;">{{__("projecttype.file")}}</label>
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="form-check form-check-sm form-check-custom form-check-solid me-3">
											<input class="form-check-input" name="main" type="checkbox" data-kt-check="true" data-kt-check-target="#kt-datatable .form-check-input" value="1" {{$obj->main == 1?'checked=checked':''}} />
                                            <span style="font-weight: bold; margin-right: 10px;">
                                            {{__("projecttype.main")}}
                                            </span>
										</div>
