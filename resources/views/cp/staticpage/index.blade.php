                    ...
                    render: function (e, t, n) {
                        ...
                        var x = '\
                                <div class="d-flex justify-content-end flex-shrink-0">\
                                    ...
                                    <a href="javascript:;" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 mt-clipboard" data-clipboard=true data-clipboard-action="copy" data-clipboard-text="{{route("home.page")}}/'+n.id+'" >\
                                    <span class="svg-icon svg-icon-3">\
											{!!__("icon.points")!!}\
										</span>\
                                    </a>\
